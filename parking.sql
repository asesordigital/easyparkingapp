...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2021 a las 02:37:59
...
ALTER TABLE `ticket`
  ...
  ADD KEY `fk-ticket1` (`id_plaza`),
  ADD KEY `fk-ticket2` (`id_usuario`),
  ADD KEY `fk-ticket3` (`no_placa`);
...
ALTER TABLE `ticket`
  ...
  ADD CONSTRAINT `fk-ticket3` FOREIGN KEY (`no_placa`) REFERENCES `vehiculo` (`placa`) ON UPDATE CASCADE;
COMMIT;
