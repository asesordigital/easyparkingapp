...
<html>
    ...
    <body>
        <div class="container-fluid" ng-app="Sprint2Parking" ng-controller="vehiculoController as vc">
                ...
                <div class="row">
                    <div class="col-12 table-responsive-xl">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr ng-repeat = "vehiculo in vc.vehiculo">  
    ...
    <script>
        //codigo Angular
        angular.module('Sprint2Parking', [])
                .controller('vehiculoController', ['$scope', function ($scope) {
        ...
        var app = angular.module('Sprint2Parking', []);
        app.controller('vehiculoController', ['$http', controladorVehiculos]);
        ...
        function controladorVehiculos($http) {
            ...
            vc.listarVehiculos = function () {
                ...
                $http({
                    ...
                    vc.vehiculo = res.data.Vehiculos;
                });
            };
